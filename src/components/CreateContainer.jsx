...
const CreateContainer = () => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      <div className="w-[90%] md:w-[70%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
        {fields && (
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div className="w-full flex flex-col md:flex-row items-center gap3">
          <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
